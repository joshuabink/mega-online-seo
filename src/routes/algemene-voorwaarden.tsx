          ...
          <div className="legal__grid">
            ...
            <Reveal as="div" className="legal__body reveal" data-d="1">
              <section className="legal__sec" id="s1">
                ...
                {' '}
                <p>
                  In deze algemene voorwaarden wordt verstaan onder ‘MegaOnline’: MegaOnline.io, gevestigd aan de Boelekade 106, 2806 AM te Gouda, ingeschreven bij de Kamer van Koophandel onder nummer 78580099, de gebruiker van deze voorwaarden. Onder ‘opdrachtgever’ wordt verstaan: de partij die met MegaOnline een overeenkomst aangaat of daartoe een aanvraag doet.
                </p>
                {' '}
                <p>
