...
const VACATURE = vacature('web-app-architect')
const URL = 'https://megaonline.io/vacatures/web-app-architect'

export const Route = createFileRoute('/vacatures/web-app-architect')({
  head: () => ({
    meta: [
