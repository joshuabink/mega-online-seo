...
const VACATURE = vacature('web-consultant')
const URL = 'https://megaonline.io/vacatures/web-consultant'

export const Route = createFileRoute('/vacatures/web-consultant')({
  head: () => ({
    meta: [
