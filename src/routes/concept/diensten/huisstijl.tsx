...
import '@/styles/pages/concept-diensten-huisstijl.css'
import '@/styles/legacy.css'

export const Route = createFileRoute('/concept/diensten/huisstijl')({
  head: () => ({
    meta: [
      { title: "" },
      { property: 'og:title', content: "" },
      { property: 'og:url', content: "https://megaonline.io/concept/diensten/huisstijl" },
    ],
    links: [
      { rel: 'canonical', href: "https://megaonline.io/concept/diensten/huisstijl" },
      {
        rel: 'stylesheet',
          ...
          <div className="container">
            <div className="dienst-hero-inner">
              <div>
                ...
                {' '}
                <Reveal as="h1" className="reveal reveal-delay-1">Huisstijl</Reveal>
                {' '}
                <Reveal as="p" className="lead reveal reveal-delay-2">
                  Van logo en kleurpalet tot volledige brand guidelines. Wij bouwen een merkidentiteit die vertrouwen wekt, onderscheidt en consistent is in elke uitingen.
                </Reveal>
                {' '}
              ...
              <Reveal as="div" className="dienst-hero-visual reveal reveal-delay-2">
                <div className="dienst-hero-visual-num">05</div>
                {' '}
        ...
        <section id="features" style={{ background: "var(--bg)" }}>
          <div className="container">
            <div style={{ marginBottom: "48px" }}>
              ...
              {' '}
              <Reveal as="h2" className="reveal reveal-delay-1" style={{ marginTop: "8px" }}>Wat we doen bij huisstijl</Reveal>
            </div>
            {' '}
            <div className="features-grid">
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                ...
                {' '}
                <p>
                  Primaire, secondaire en neutrale kleuren met gebruik-richtlijnen.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-3">
                ...
                {' '}
                <p>
                  Lettertypekeuze, schaalverdeling en leesbaarheid op alle media.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-1">
                ...
                {' '}
                <h3>Grafische elementen</h3>
                {' '}
                <p>
                  Iconen, patronen en illustratiestijl die je merk versterken.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                ...
                {' '}
                <p>
                  Volledig handboek zodat iedereen consistent je merk toepast.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-3">
            ...
            <div className="steps-row">
              <Reveal as="div" className="step-item reveal reveal-delay-1">
                ...
                <div>
                  <h3>Merkstrategie</h3>
                  {' '}
                  <p>Positionering, doelgroep en merkwaarden</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-2">
                ...
                <div>
                  <h3>Concepten</h3>
                  {' '}
                  <p>3 visuele richtingen, jij kiest</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-3">
                ...
                <div>
                  <h3>Uitwerking</h3>
                  {' '}
                  <p>Gekozen richting volledig uitwerken</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-4">
                ...
                <div>
                  <h3>Oplevering</h3>
                  {' '}
                  <p>Brand guidelines + alle bestanden</p>
                </div>
              </Reveal>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <Reveal as="div" className="faq-list reveal reveal-delay-2">
              <div className="faq-item">
                <div className="faq-q">
                  Leveren jullie ook de bestanden mee?
                  {' '}
              ...
              <div className="faq-item">
                <div className="faq-q">
                  Kunnen jullie ook onze bestaande huisstijl doorontwikkelen?
                  {' '}
                  <span className="faq-icon">+</span>
                </div>
                {' '}
                <div className="faq-a">
                  <div className="faq-a-inner">
                    Zeker. We doen regelmatig rebrands en huisstijl-updates die aansluiten op wat al bestaat.
                  </div>
                </div>
              </div>
              {' '}
              <div className="faq-item">
                <div className="faq-q">
                  Maken jullie ook de website na de huisstijl?
                  {' '}
                  <span className="faq-icon">+</span>
                </div>
                {' '}
