...
import '@/styles/pages/concept-diensten-automatiseringen.css'
import '@/styles/legacy.css'

export const Route = createFileRoute('/concept/diensten/automatiseringen')({
  head: () => ({
    meta: [
      { title: "" },
      { property: 'og:title', content: "" },
      { property: 'og:url', content: "https://megaonline.io/concept/diensten/automatiseringen" },
    ],
    links: [
      { rel: 'canonical', href: "https://megaonline.io/concept/diensten/automatiseringen" },
      {
        rel: 'stylesheet',
  ...
  component: Automatiseringen,
})

function Automatiseringen() {
  return (
          ...
          <div className="container">
            <div className="dienst-hero-inner">
              ...
              <Reveal as="div" className="dienst-hero-visual reveal reveal-delay-2">
                <div className="dienst-hero-visual-num">07</div>
                {' '}
        ...
        <section id="features" style={{ background: "var(--bg)" }}>
          <div className="container">
            <div style={{ marginBottom: "48px" }}>
              ...
              {' '}
              <Reveal as="h2" className="reveal reveal-delay-1" style={{ marginTop: "8px" }}>Wat we doen bij automatiseringen</Reveal>
            </div>
            {' '}
            <div className="features-grid">
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                ...
                {' '}
                <h3>E-mail automations</h3>
                {' '}
                <p>
                  Triggers op basis van klantacties, ingevulde formulieren of tijdschema.
                </p>
              </Reveal>
              {' '}
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-1">
                ...
                {' '}
                <h3>Notificaties & alerts</h3>
                {' '}
                <p>Automatische meldingen bij uitzonderingen of mijlpalen.</p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                <div className="feature-icon">
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-3">
                ...
                <h3>Make & Zapier</h3>
                {' '}
                <p>No-code platformen ingezet waar snel en kostenefficiënt.</p>
              </Reveal>
            </div>
          </div>
        </section>
            ...
            <div className="steps-row">
              <Reveal as="div" className="step-item reveal reveal-delay-1">
                ...
                <div>
                  ...
                  {' '}
                  <p>Welke processen kosten het meeste tijd?</p>
                </div>
              </Reveal>
              {' '}
              ...
              <Reveal as="div" className="step-item reveal reveal-delay-3">
                ...
                <div>
                  <h3>Bouwen</h3>
                  {' '}
                  <p>Automations bouwen en testen</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-4">
                ...
                <div>
                  <h3>Overdracht</h3>
                  {' '}
                  <p>Live + beheer of overdracht aan jouw team</p>
                </div>
              </Reveal>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <Reveal as="div" className="faq-list reveal reveal-delay-2">
              <div className="faq-item">
                <div className="faq-q">
                  Welke tools gebruiken jullie voor automatiseringen?
                  {' '}
              ...
              <div className="faq-item">
                <div className="faq-q">
                  Kan ik zelf automations beheren na oplevering?
                  {' '}
                  <span className="faq-icon">+</span>
                </div>
                {' '}
                <div className="faq-a">
                  <div className="faq-a-inner">
                    Ja, we leveren op met documentatie en zorgen dat je zelf kleine aanpassingen kunt doen.
                  </div>
                </div>
              </div>
              {' '}
              <div className="faq-item">
                <div className="faq-q">
                  Wat als een automatisering breekt?
                  {' '}
                  <span className="faq-icon">+</span>
                </div>
                {' '}
                <div className="faq-a">
                  <div className="faq-a-inner">
                    We bouwen met foutafhandeling en alerts. Bij problemen krijg jij direct een melding.
                  </div>
                </div>
              </div>
            </Reveal>
