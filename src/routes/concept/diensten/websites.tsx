...
import '@/styles/pages/concept-diensten-websites.css'
import '@/styles/legacy.css'

export const Route = createFileRoute('/concept/diensten/websites')({
  head: () => ({
    meta: [
      { title: "" },
      { property: 'og:title', content: "" },
      { property: 'og:url', content: "https://megaonline.io/concept/diensten/websites" },
    ],
    links: [
      { rel: 'canonical', href: "https://megaonline.io/concept/diensten/websites" },
      {
        rel: 'stylesheet',
          ...
          <div className="container">
            <div className="dienst-hero-inner">
              <div>
                ...
                {' '}
                <Reveal as="h1" className="reveal reveal-delay-1">Websites</Reveal>
                {' '}
                <Reveal as="p" className="lead reveal reveal-delay-2">
                  Een website die niet alleen mooi oogt, maar ook gevonden wordt en bezoekers omzet in klanten. Wij bouwen op maat of via een slim CMS dat jij zelf beheert.
                </Reveal>
                {' '}
              ...
              <Reveal as="div" className="dienst-hero-visual reveal reveal-delay-2">
                <div className="dienst-hero-visual-num">01</div>
                {' '}
        ...
        <section id="features" style={{ background: "var(--bg)" }}>
          <div className="container">
            <div style={{ marginBottom: "48px" }}>
              ...
              {' '}
              <Reveal as="h2" className="reveal reveal-delay-1" style={{ marginTop: "8px" }}>Wat we doen bij websites</Reveal>
            </div>
            {' '}
            <div className="features-grid">
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                ...
                {' '}
                <p>
                  Technische SEO ingebakken vanaf dag één. Beter gevonden, meer bereik.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-3">
                ...
                {' '}
                <p>
                  Beheer je content via WordPress, Webflow of een ander CMS naar keuze.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-1">
              ...
              <Reveal as="div" className="feature-card reveal reveal-delay-2">
                ...
                {' '}
                <h3>Veilig & onderhouden</h3>
                {' '}
                <p>
                  SSL, updates en monitoring. Wij houden je site veilig en up-to-date.
                </p>
              </Reveal>
              {' '}
              <Reveal as="div" className="feature-card reveal reveal-delay-3">
                ...
                {' '}
                <h3>Analytics & conversie</h3>
                {' '}
                <p>
                  Ingebouwde tracking zodat je precies ziet wat werkt en wat niet.
                </p>
              </Reveal>
            </div>
          </div>
            ...
            <div className="steps-row">
              <Reveal as="div" className="step-item reveal reveal-delay-1">
                ...
                <div>
                  <h3>Briefing</h3>
                  {' '}
                  <p>Doelen, doelgroep en concurrentie in kaart</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-2">
                ...
                <div>
                  <h3>Design</h3>
                  {' '}
                  <p>Wireframes & visueel ontwerp, jij keurt goed</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-3">
                ...
                <div>
                  <h3>Bouw</h3>
                  {' '}
                  <p>Development, testen op alle devices</p>
                </div>
              </Reveal>
              {' '}
              <Reveal as="div" className="step-item reveal reveal-delay-4">
                ...
                <div>
                  <h3>Live</h3>
                  {' '}
                  <p>Launch + SEO-check + jij kan zelf alles beheren</p>
                </div>
              </Reveal>
            </div>
          </div>
        ...
        <section style={{ background: "var(--bg)" }}>
          <div className="container">
            ...
            <Reveal as="div" className="faq-list reveal reveal-delay-2">
              ...
              <div className="faq-item">
                <div className="faq-q">
                  Kan ik mijn website zelf aanpassen na oplevering?
                  {' '}
                  <span className="faq-icon">+</span>
                </div>
                {' '}
                <div className="faq-a">
                  <div className="faq-a-inner">
                    Ja, altijd. We leveren op met een CMS en geven een korte training zodat je direct zelfstandig kunt werken.
                  </div>
                </div>
              </div>
              {' '}
              <div className="faq-item">
                ...
                <div className="faq-a">
                  <div className="faq-a-inner">
                    Gemiddeld 2–5 weken, afhankelijk van de complexiteit en hoe snel content en feedback beschikbaar is.
                  </div>
                </div>
              </div>
            </Reveal>
        ...
        <section className="dienst-cta">
          <div className="container">
            <div className="dienst-cta-inner">
              ...
              {' '}
              <h2>Klaar voor een website die echt werkt?</h2>
              {' '}
              <p>
                Plan een gratis gesprek en we kijken samen wat de beste aanpak is voor jouw situatie.
              </p>
              {' '}
